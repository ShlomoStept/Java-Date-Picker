...
//------------------------------------------------------------------------------------------------------------------------------------------------
Author: Shlomo Stept
Project: This project aimed at providing a Java Swing Date-picker Calendar JFrame (open up a window application)
            --Java Swing Date-picker Calendar JPanel -- to place within another applications JFrame use the other github class
...
public class JavaSwingDatePickerJframeGUI implements Runnable {
...
//---------------------------------------------------------------------------------------------------------------------
    ...
    public static void main(String[] args) {
        new JavaSwingDatePickerJframeGUI ();
    }
    ...
    //-->>> //-->>> //-->>>
    // B. FONTS --> font family and size can be changed
    //-->>> //-->>> //-->>>
    ...
    // 2.0 --> ::: CONSTRUCTOR :::
    //-----------------------------------------------------------------------
    public JavaSwingDatePickerJframeGUI() {
